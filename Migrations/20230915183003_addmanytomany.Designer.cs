...
namespace HomeTaskkMVC4.Migrations
{
    ...
    [Migration("20230915183003_addmanytomany")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomeTaskkMVC4.Models.DemoEntities.BookAuthor", b =>
                {
                    b.HasOne("HomeTaskkMVC4.Models.DemoEntities.Author", null)
                        .WithMany("BookAuthors")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HomeTaskkMVC4.Models.DemoEntities.Book", null)
                        .WithMany("BookAuthors")
            ...
            modelBuilder.Entity("HomeTaskkMVC4.Models.DemoEntities.BookGenres", b =>
                {
                    ...
                    b.HasOne("HomeTaskkMVC4.Models.DemoEntities.Genre", null)
                        .WithMany("BookGenres")
